    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[400px] flex items-center">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1552728089-57bdde30beb3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
            alt="Bird care"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Specialized Bird Care Services
            </h1>
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Expert care and guidance for your avian companions
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: "Regular health checks and preventive care"
              },
              {
                icon: <Shield className="h-8 w-8 text-indigo-600" />,
                title: "Behavioral Training",
                description: "Training techniques for various bird species"
              },
              {
                icon: <Book className="h-8 w-8 text-indigo-600" />,
                title: "Diet Planning",
                description: "Species-specific nutrition guidance"
              },
              {
                icon: <AlertCircle className="h-8 w-8 text-indigo-600" />,
                title: "Emergency Care",
                description: "Immediate support for critical situations"
              }
            ].map((service, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Essential Bird Care Guidelines</h2>
      ...
      <section className="py-16 bg-indigo-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Need Expert Avian Care Advice?
          </h2>
          <p className="text-xl text-indigo-100 mb-8">
            Consult with our specialized bird care professionals
          </p>
